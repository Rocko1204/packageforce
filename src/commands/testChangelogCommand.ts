...
export async function testChangelogFlow() {
  try {
    ...
    await vscode.window.showInformationMessage('Test 1: Information message works');
    ...
    await vscode.window.showInformationMessage(`Warning selection: ${warning || 'cancelled'}`);
